  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类执行人</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类文章基数</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类引用配置</span></div></td>
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类时间</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">是否当前配置</span></div></td>
        
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">设置为当前</span></div></td>
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">查看聚类结果</span></div></td>

      </tr>
			<c:forEach items="${clusterHistoryList}" var="clusterHistory" begin="0"  varStatus="s">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${clusterHistory.admin.name}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${clusterHistory.chWebpageNum}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="cluster/clusterConfig_detail?clusterConfig.id=${clusterHistory.chCclId}">${clusterHistory.chCclId}</a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${clusterHistory.chTime}</div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><c:if test="${clusterHistory.present==true }">是</c:if><c:if test="${clusterHistory.present==false }">否</c:if></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="cluster/clusterHistory_present?clusterHistory.id=${clusterHistory.id }">设置为当前</a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="cluster/clusterResult_detail?clusterResult.chId=${clusterHistory.id }">查看详细</a></div></td>
