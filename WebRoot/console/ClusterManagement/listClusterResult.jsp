  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类主题词</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">包含新闻数目</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">聚类历史id</span></div></td>


      </tr>
			<c:forEach items="${clusterResultList}" var="clusterResult" begin="0"  varStatus="s">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${clusterResult.cTitle}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${fn:length(clusterResult.news)}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="/crawler/cluster/clusterHistory_detail?clusterHistory.id=${clusterResult.chId}">${clusterResult.chId}</a></div></td>
