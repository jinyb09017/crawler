  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">种子URL</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">站点名称</span></div></td>



      </tr>
			<c:forEach items="${crawlerSeedsList}" var="crawlerSeeds" begin="0"  varStatus="s">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div >&nbsp;${crawlerSeeds.website}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${crawlerSeeds.description}</div></td>
