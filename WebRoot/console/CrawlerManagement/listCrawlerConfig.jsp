  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">配置人</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">线程数</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">站点总数</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">是否当前配置</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">查看详细</span></div></td>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">设为当前配置</span></div></td>
 

      </tr>
			<c:forEach items="${crawlerConfigList}" var="crawlerConfig" begin="0"  varStatus="s">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${crawlerConfig.admin.name}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${crawlerConfig.ccThreads}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${fn:length(crawlerConfig.seeds)}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><c:if test="${crawlerConfig.present==true }">是</c:if><c:if test="${crawlerConfig.present==false }">否</c:if></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="/crawler/crawler/crawlerConfig_detail?crawlerConfig.id=${crawlerConfig.id }">详细</a></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="/crawler/crawler/crawlerConfig_present?crawlerConfig.id=${crawlerConfig.id }">设置为当前</a></div></td>
